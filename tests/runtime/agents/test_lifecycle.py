...
from app.runtime.agents.lifecycle import (
...
class DummyHook(IAgentHooks):
    ...
    def before_initialize(self, agent):
        self.called.append("before_initialize")

    def after_initialize(self, agent):
        self.called.append("after_initialize")

    def before_execute(self, agent):
        self.called.append("before_execute")

    def after_execute(self, agent, result):
        self.called.append("after_execute")

    def before_suspend(self, agent):
        self.called.append("before_suspend")

    def after_resume(self, agent):
        self.called.append("after_resume")

    def before_shutdown(self, agent):
        self.called.append("before_shutdown")

    def after_shutdown(self, agent):
        self.called.append("after_shutdown")
