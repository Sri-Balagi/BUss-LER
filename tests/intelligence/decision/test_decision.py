...
def test_evaluate_decision_alternatives():
    ...
    objective = ExecutiveObjective(objective_id="obj_1", description="desc", priority=ObjectivePriority.HIGH)
    ...
    a3 = DecisionAlternative(alternative_id="a3", description="Opt3", estimated_value=300.0, policy_compliance=False)
...
def test_evaluate_no_valid_alternatives():
    ...
    a1 = DecisionAlternative(alternative_id="a1", description="Opt1", estimated_value=100.0, constraint_compliance=False)
