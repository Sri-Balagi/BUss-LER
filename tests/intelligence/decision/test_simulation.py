...
def test_simulate():
    ...
    scenario1 = SimulationScenario(scenario_id="scen1", plan_id="p1", variables={"market_growth": 50.0})
    scenario2 = SimulationScenario(scenario_id="scen2", plan_id="p1", variables={"market_growth": -20.0})
