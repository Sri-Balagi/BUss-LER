...
def test_synthesize_knowledge():
    ...
    evaluation = OutcomeEvaluation(evaluation_id="e1", plan_id="p1", overall_score=SuccessScore.ACHIEVED)
    ...
    evaluation_fail = OutcomeEvaluation(evaluation_id="e2", plan_id="p2", overall_score=SuccessScore.FAILED)
