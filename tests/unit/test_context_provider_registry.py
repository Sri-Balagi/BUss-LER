...
from app.application.context.provider_registry import (
    ContextProviderRegistry,
    DuplicateProviderRegistrationError,
)
from app.application.context.providers.abstract import AbstractContextProvider
from app.intelligence.intake.situation.enterprise_context import ContextSection, ProviderMetadata
...
def test_iteration_and_length():
    ...
    expected_order = sorted(
        [ContextSource.MEMORY, ContextSource.TWIN, ContextSource.GOAL], key=lambda s: s.value
    )
