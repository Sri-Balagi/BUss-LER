...
class BizObject(BaseModel):
    ...
    tenant_id: Optional[UUID] = Field(default=None, description="Identifier for the overarching tenant organization.")
    owner_id: Optional[UUID] = Field(default=None, description="Specific UUID of the user or twin that owns this object.")
    correlation_id: Optional[UUID] = Field(default=None, description="Used for distributed tracing across workflows.")
