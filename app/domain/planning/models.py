...
class PlanningContext(IntelligenceContext):
    ...
    active_twin: TwinSnapshot | None = Field(None, description="The current state of the twin.")
...
class Plan(BaseModel):
    ...
    def transition_status(self, new_status: PlanStatus, errors: list[str] | None = None) -> None:
