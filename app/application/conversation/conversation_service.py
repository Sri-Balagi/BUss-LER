...
from app.shared.events.models import ConversationUpdatedEvent

from app.infrastructure.persistence.postgres.repositories.conversation_repository import AbstractConversationRepository
