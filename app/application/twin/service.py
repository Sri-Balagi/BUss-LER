...
class DigitalTwinService:
    ...
    async def get_twin(self, context: IntelligenceContext, entity_id: UUID) -> Optional[DigitalTwinState]:
    ...
    async def update_twin_properties(self, context: IntelligenceContext, entity_id: UUID, properties: dict) -> Optional[DigitalTwinState]:
        provider = self._get_provider()
