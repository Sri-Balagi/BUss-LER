...
class TelegramConnector(BaseMessagingConnector):
    """Telegram Bot API connector implementation."""

    def __init__(self, connector_id: str = "telegram", profile_id: str | None = None, **kwargs: Any) -> None:
    ...
    async def send_message(
        ...
        return CanonicalMessage(
            ...
            source_id="tg_msg_1001",
            channel_id=recipient_id,
            sender_id="telegram_bot",
            content=content,
        )
