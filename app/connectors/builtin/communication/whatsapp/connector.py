"""WhatsApp Business Connector Implementation."""
...
class WhatsAppConnector(BaseMessagingConnector):
    """WhatsApp Business Cloud API connector implementation."""

    def __init__(self, connector_id: str = "whatsapp", profile_id: str | None = None, **kwargs: Any) -> None:
    ...
    async def send_message(
        ...
        return CanonicalMessage(
            ...
            source_id="wa_msg_1001",
            channel_id=recipient_id,
            sender_id="whatsapp_biz",
            content=content,
        )
