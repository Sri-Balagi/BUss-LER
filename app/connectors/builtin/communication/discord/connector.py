...
class DiscordConnector(BaseMessagingConnector):
    """Discord Bot API connector implementation."""

    def __init__(self, connector_id: str = "discord", profile_id: str | None = None, **kwargs: Any) -> None:
    ...
    async def send_message(
        ...
        return CanonicalMessage(
            ...
            source_id="discord_msg_1001",
            channel_id=recipient_id,
            sender_id="discord_bot",
            content=content,
        )
