"""Facebook Messenger Connector Implementation."""
...
class FBMessengerConnector(BaseMessagingConnector):
    """Facebook Messenger API connector implementation."""

    def __init__(self, connector_id: str = "messenger", profile_id: str | None = None, **kwargs: Any) -> None:
    ...
    async def send_message(
        ...
        return CanonicalMessage(
            ...
            source_id="fbm_msg_1001",
            channel_id=recipient_id,
            sender_id="messenger_bot",
            content=content,
        )
