"""Signal Connector Implementation Stub."""
...
class SignalConnector(BaseMessagingConnector):
    """Signal Messaging connector architecture stub."""

    def __init__(self, connector_id: str = "signal", profile_id: str | None = None, **kwargs: Any) -> None:
        super().__init__(connector_id=connector_id, profile_id=profile_id)

    def get_capabilities(self) -> list[str]:
        return ["signal.messaging"]
