...
class InstagramConnector(BaseMessagingConnector):
    """Instagram Messaging API connector implementation."""

    def __init__(self, connector_id: str = "instagram", profile_id: str | None = None, **kwargs: Any) -> None:
    ...
    async def send_message(
        ...
        return CanonicalMessage(
            ...
            source_id="ig_msg_1001",
            channel_id=recipient_id,
            sender_id="instagram_bot",
            content=content,
        )
