...
class TeamsConnector(BaseMessagingConnector):
    """Microsoft Graph API Teams connector implementation."""

    def __init__(self, connector_id: str = "teams", profile_id: str | None = None, **kwargs: Any) -> None:
