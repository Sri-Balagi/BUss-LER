...
def parse_onenote_webhook(payload_bytes: bytes, headers: Dict[str, str]) -> CanonicalWebhookEvent:
    """Parses raw Graph webhook notification for OneNote changes."""
