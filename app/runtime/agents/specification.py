...
class AgentSpecification(BaseModel):
    ...
    """
    identity: str = Field(description="Unique identity slug for the agent class (e.g., 'revenue-forecaster')")
    capabilities: list[str] = Field(default_factory=list, description="List of capabilities this agent fulfills")
    permissions: list[AgentPermission] = Field(default_factory=list, description="Declarative boundaries enforced by the Context")
