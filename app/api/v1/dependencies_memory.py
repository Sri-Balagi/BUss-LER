...
from app.api.v1.dependencies_core import get_supabase_client, get_qdrant_client, get_event_bus
from app.api.v1.dependencies_ai import get_ai_kernel
from app.events.bus import EventBus
from app.services.ai.kernel import AbstractAIKernel

async def get_memory_metadata_repository(client: AsyncClient = Depends(get_supabase_client)):
