    ...
    def build(cls, module_name: str) -> list[AIPersona]:
        return [
            ...
            AIPersona(
                ...
                name="Lead Document Management Specialist",
                description="Primary operational persona for document_management.",
            ...
            AIPersona(
                ...
                name="Document Management Auditor",
                description="Oversight persona for document_management.",
