    ...
    def build(cls, module_name: str) -> list[AIPersona]:
        return [
            ...
            AIPersona(
                ...
                name="Lead Asset Management Specialist",
                description="Primary operational persona for asset_management.",
            ...
            AIPersona(
                ...
                name="Asset Management Auditor",
                description="Oversight persona for asset_management.",
