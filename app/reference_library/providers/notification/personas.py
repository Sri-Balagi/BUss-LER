    ...
    def build(cls, module_name: str) -> list[AIPersona]:
        return [
            ...
            AIPersona(
                ...
                name="Lead Notification Specialist",
                description="Primary operational persona for notification.",
            ...
            AIPersona(
                ...
                name="Notification Auditor",
                description="Oversight persona for notification.",
