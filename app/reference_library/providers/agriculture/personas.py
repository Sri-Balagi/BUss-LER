    ...
    def build(cls, module_name: str) -> list[AIPersona]:
        return [
            ...
            AIPersona(
                ...
                name="Lead Agriculture Specialist",
                description="Primary operational persona for agriculture.",
            ...
            AIPersona(
                ...
                name="Agriculture Auditor",
                description="Oversight persona for agriculture.",
