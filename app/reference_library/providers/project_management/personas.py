    ...
    def build(cls, module_name: str) -> list[AIPersona]:
        return [
            ...
            AIPersona(
                ...
                name="Lead Project Management Specialist",
                description="Primary operational persona for project_management.",
            ...
            AIPersona(
                ...
                description="Oversight persona for project_management.",
