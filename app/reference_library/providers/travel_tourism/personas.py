    ...
    def build(cls, module_name: str) -> list[AIPersona]:
        return [
            ...
            AIPersona(
                ...
                name="Lead Travel Tourism Specialist",
                description="Primary operational persona for travel_tourism.",
            ...
            AIPersona(
                ...
                name="Travel Tourism Auditor",
                description="Oversight persona for travel_tourism.",
