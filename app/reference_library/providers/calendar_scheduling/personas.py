    ...
    def build(cls, module_name: str) -> list[AIPersona]:
        return [
            ...
            AIPersona(
                ...
                name="Lead Calendar Scheduling Specialist",
                description="Primary operational persona for calendar_scheduling.",
            ...
            AIPersona(
                ...
                name="Calendar Scheduling Auditor",
                description="Oversight persona for calendar_scheduling.",
