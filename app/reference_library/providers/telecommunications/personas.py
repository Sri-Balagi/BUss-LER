    ...
    def build(cls, module_name: str) -> list[AIPersona]:
        return [
            ...
            AIPersona(
                ...
                name="Lead Telecommunications Specialist",
                description="Primary operational persona for telecommunications.",
            ...
            AIPersona(
                ...
                name="Telecommunications Auditor",
                description="Oversight persona for telecommunications.",
