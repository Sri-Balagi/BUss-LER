...
class BaseReferenceProvider:
    ...
    ontology: type[KnowledgePack] | None = None
    vocabulary: type[KnowledgePack] | None = None
    objectives: type[KnowledgePack] | None = None
    kpis: type[KnowledgePack] | None = None
    processes: type[KnowledgePack] | None = None
    constraints: type[KnowledgePack] | None = None
    regulations: type[KnowledgePack] | None = None
    personas: type[KnowledgePack] | None = None
    decisions: type[KnowledgePack] | None = None
    actions: type[KnowledgePack] | None = None
    capability_definitions: type[KnowledgePack] | None = None
    context_contributors: type[KnowledgePack] | None = None
    policies: type[KnowledgePack] | None = None
    state_transitions: type[KnowledgePack] | None = None
    events: type[KnowledgePack] | None = None
    temporal_patterns: type[KnowledgePack] | None = None
    taxonomies: type[KnowledgePack] | None = None
