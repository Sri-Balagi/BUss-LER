...
def capability(name: str, description: str = ""):
    ...
    def decorator(func: Callable[..., Any]) -> Callable[..., Any]:
        setattr(func, "__is_bizos_capability__", True)
        setattr(func, "__capability_name__", name)
        setattr(func, "__capability_desc__", description)
...
def shell_command(name: str):
    ...
    """
    def decorator(func: Callable[..., Any]) -> Callable[..., Any]:
        setattr(func, "__is_bizos_shell_command__", True)
        setattr(func, "__shell_command_name__", name)
