...
class SDKConfig(BaseModel):
    ...
    api_key: Optional[str] = Field(default_factory=lambda: os.getenv("BIZOS_API_KEY"))
    jwt_token: Optional[str] = Field(default_factory=lambda: os.getenv("BIZOS_JWT_TOKEN"))
    tenant_id: Optional[str] = Field(default_factory=lambda: os.getenv("BIZOS_TENANT_ID"))
